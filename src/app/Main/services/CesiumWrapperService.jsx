...
(function (){
    'use strict';
    app.service('CesiumWrapperService', [ 'SettingsLoaderService',
        ...
        this.subscribeToHeadingChanged = function(func, context){
            Hermes.registerEvent('HeadingChanged', 
            function(...args){
        ...
        SettingsLoaderService.loadSettings({jsonUrl: "assets/CesiumContainerSettings.json", caller: this, callback: this.initializeCesiumViewer});
